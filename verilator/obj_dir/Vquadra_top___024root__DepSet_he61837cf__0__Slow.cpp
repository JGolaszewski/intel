...
#endif
            VL_FATAL_MT("/home/jgolaszewski/intel/rtl-model/quadra_top.vs", 4, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vquadra_top___024root___ctor_var_reset(Vquadra_top___024root* vlSelf) {
    ...
    vlSelf->quadra_top__DOT__y_from_quadra = VL_RAND_RESET_I(25);
    vlSelf->quadra_top__DOT__y_p1 = VL_RAND_RESET_I(25);
    vlSelf->quadra_top__DOT__y_p2 = VL_RAND_RESET_I(25);
    vlSelf->quadra_top__DOT__u_quadra__DOT__coeff_a = VL_RAND_RESET_I(22);
    vlSelf->quadra_top__DOT__u_quadra__DOT__coeff_b = VL_RAND_RESET_I(17);
    vlSelf->quadra_top__DOT__u_quadra__DOT__coeff_c = VL_RAND_RESET_I(17);
    vlSelf->quadra_top__DOT__u_quadra__DOT__unnamedblk1__DOT__sq_fxd = VL_RAND_RESET_I(13);
    vlSelf->quadra_top__DOT__u_quadra__DOT__unnamedblk1__DOT__t0_fxd = VL_RAND_RESET_I(30);
    vlSelf->quadra_top__DOT__u_quadra__DOT__unnamedblk1__DOT__p1 = VL_RAND_RESET_Q(35);
    vlSelf->quadra_top__DOT__u_quadra__DOT__unnamedblk1__DOT__t1_fxd = VL_RAND_RESET_I(30);
    vlSelf->quadra_top__DOT__u_quadra__DOT__unnamedblk1__DOT__p2 = VL_RAND_RESET_I(31);
    vlSelf->quadra_top__DOT__u_quadra__DOT__unnamedblk1__DOT__t2_fxd = VL_RAND_RESET_I(30);
    vlSelf->quadra_top__DOT__u_quadra__DOT__unnamedblk1__DOT__s_fxd = VL_RAND_RESET_I(30);
